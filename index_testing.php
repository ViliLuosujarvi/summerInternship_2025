...
<head>
  ...
  <style>
    ...
    .cabins {
      ...
      flex-wrap: nowrap; /* keep cabins on same row */
    }
    .cabin-card {
      background:#fff;
      padding:1rem;
...
<body>
  ...
  <script>
    const cabins = {
      helmi1: { title:"Helmi 1", description:"Cozy cabin by Käränkävaara ridge. Sleeps 4.", priceTiers:{'2':75,'3-5':70,'6+':50}, cleaning:100, linen:25,
        images:["https://media.houseandgarden.co.uk/photos/63a1a9b588e2d802928c6499/2:3/w_2000,h_3000,c_limit/MFOX7961.jpg",
                "https://hips.hearstapps.com/hmg-prod/images/clx100122welldargenzio-002-2-66d768fc6c262.jpg"]
      },
      helmi2: { title:"Helmi 2", description:"Rustic cabin with sauna. Sleeps 6.", priceTiers:{'2':120,'3-5':110,'6+':70}, cleaning:100, linen:25,
        images:["https://cf.bstatic.com/xdata/images/hotel/max1024x768/615536116.jpg?k=1105a0cd9fd25cd7ebe53a200226d44a240536de1369da10089033a61471f2b9&o=&hp=1",
                "https://cdn.mos.cms.futurecdn.net/9AW7pCmj5LmquUGiXLRhUW.jpg"]
      },
      helmi3: { title:"Helmi 3", description:"Modern cabin with fireplace. Sleeps 6.", priceTiers:{'2':110,'3-5':100,'6+':60}, cleaning:100, linen:25,
        images:["https://images.fineartamerica.com/images/artworkimages/mediumlarge/1/cabin-at-the-lake-thomas-nay.jpg",
    ...
    function calculatePriceClient(){
      ...
      let total = pickPriceForNights(cabins[cabinKey].priceTiers,nights)*nights;
    ...
    form.addEventListener('submit', e=>{
      const nights = getNights(form.checkin.value,form.checkout.value);
      if(isNaN(nights)||nights<2){ e.preventDefault();
