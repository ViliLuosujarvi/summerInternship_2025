...
<main>
  ...
  <section class="all-reservations">
    ...
    if($conn->connect_error){ echo "<p>DB connection error.</p>"; }
      ...
      $res = $conn->query("SELECT id,cabin,checkin,checkout,total_price,payment_status,created_at FROM reservations ORDER BY created_at DESC");
...
form.addEventListener('submit',(e)=>{
  ...
  // Show confirmation message while server processes
